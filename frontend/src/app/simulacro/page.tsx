      ...
      <div className="w-full max-w-md space-y-6">
        ...
        {!ticket || st === "expired" ? (
          ...
          <div className="bg-card border border-emerald-700 rounded-2xl p-5 space-y-4 text-center">
            ...
            <DatosSimulacro datos={state?.datos} />
...
function DatosSimulacro({ datos }: { datos?: string }) {
  // NO mostramos el nombre de la personalidad/escenario: es interno y revelaría
  // el tipo de llamada. La asesora solo ve la ficha (datos para el agente).
  ...
  return (
    <div className="rounded-xl border border-border bg-bg/40 p-3 text-left">
      ...
      <p className="text-sm text-zinc-300 whitespace-pre-wrap">{datos}</p>
    </div>
  );
}
